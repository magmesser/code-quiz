...
saveHighScore = (e) => {
  ...
  console.table(highScoresList)
  scoreboardList.innerHTML = highScoresList
  .map((score) => {
...
const questionsArray = [
  ...
  {
    question:
      "A variable that is defined within a function is known as _____ scope?",
    answers: [
  ...
  {
    question:
      "Which index is the letter 'D' on from the following array? ['A', 'B', 'C', 'D'] ",
    answers: [
